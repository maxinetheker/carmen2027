...
<dialog class="presentation-modal" data-presentation-modal>
    <form method="dialog"><button class="modal-close" type="submit" aria-label="Cerrar">×</button></form>
    <form data-presentation-form action="{{ route('admin.properties.presentations.store', $record) }}" enctype="multipart/form-data">
        <h2>Generar presentación PDF</h2>
        ...
        <div class="modal-actions">
            <button class="button button-ghost-dark" type="button" data-close-presentation-modal>Cancelar</button>
